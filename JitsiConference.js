...
import P2PDominantSpeakerDetection
    from './modules/detection/P2PDominantSpeakerDetection';
...
import ReceiveVideoController
    from './modules/qualitycontrol/ReceiveVideoController';
import SendVideoController from './modules/qualitycontrol/SendVideoController';
import RecordingManager from './modules/recording/RecordingManager';
import Settings from './modules/settings/Settings';
import AudioOutputProblemDetector
    from './modules/statistics/AudioOutputProblemDetector';
 ...
 *
 *
 * 为一个jid 创建一个资源 ... 我们使用房间昵称(JID 的资源部分信息, 查看 XEP-0045) - 在colibri中作为 端点id
 * 我们需要端点id 8位16进制数字,因为某些情况下,它们会序列化为 32字节字段 ...
 *
